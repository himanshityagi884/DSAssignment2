...
1. Identify the most profitable movie and analyze its cast and crew
2. Determine which language yields the highest average ROI
3. Explore all unique movie genres
4. Analyze producers and directors based on ROI
5. Identify the most active actor and analyze their performance
6. Study director preferences for actors
